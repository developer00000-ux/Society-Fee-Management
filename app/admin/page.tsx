    ...
    <ProtectedRoute requiredRoles={['super_admin', 'colony_admin', 'block_manager']}>
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Flats Management */}
          <Link href="/admin/flats" className="block">
            <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
          ...
          <Link href="/" className="block">
            <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Back to Main</h3>
              <p className="text-gray-600">Return to fee management form</p>
            </div>
          </Link>
        </div>
        </div>
