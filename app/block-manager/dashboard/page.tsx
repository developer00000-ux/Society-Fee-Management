          ...
          <div className="px-4 py-6 sm:px-0">
            <div className="border-4 border-dashed border-gray-200 rounded-lg h-96 flex items-center justify-center">
              <div className="text-center">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">Block Manager Dashboard</h3>
                <p className="mt-1 text-sm text-gray-500">
                  Welcome to the Block Manager Dashboard. This area will contain building-specific management features.
                </p>
                <div className="mt-6">
                      ...
                      <div className="p-5">
                        <div className="flex items-center">
                          ...
                          <div className="ml-5 w-0 flex-1">
                            <dl>
                              <dt className="text-sm font-medium text-gray-500 truncate">Floors</dt>
